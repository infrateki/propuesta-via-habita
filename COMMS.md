...
**Last updated:** 2026-04-29 · v10.0 cut, reseteada sobre la base correcta: PROPOSAL-v10.md construida desde el contenido extraído de INFRATEK_Propuesta_VIA-HABITA_2026_v8.pdf (formato carta ejecutiva, 10 páginas, equivalencias CLP/UF) con la retroalimentación de Pablo del 29 abril sobreimpuesta. v9 cut anterior fue construido sobre la base equivocada (PROPOSAL-v5.md) y se descarta. PDF/DOCX regenerados como _v10. Site refs bumped v9 → v10.0 · 29 ABR 2026.
**Status:** 🟢 DEPLOYED
