...
**Last updated:** 2026-04-29 · Reconciliation pass: restored multi-platform Precios tab and Autodesk costs alongside Pablo's 3-scenario narrative. 4-tab comparativo: Análisis | Precios | Costos Autodesk | Funcionalidades. VisionSection trimmed to a tight 2-column layout (quote + horizons list) so it reads as a closing note instead of a full section. Home page placeholder paragraph (referenced "v4.0 en Phase 3") replaced with a real teaser linking to /propuesta#problema.
**Status:** 🟢 DEPLOYED
