...
> **Cambios en v11 (30 Abr 2026):** ajustes editoriales sobre la v10. El comparativo, los tres escenarios (10 → diagnóstico → 100 usuarios), los 6 perfiles, el §14 Horizonte estratégico, los precios y las fechas confirmadas se mantienen intactos. Esta revisión neutraliza referencias personales y suaviza el lenguaje en las secciones de diagnóstico y argumento.
...
A 10 usuarios, **Autodesk resulta $2,000 más económico.** La pregunta natural es: ¿por $2,000 menos al año, no conviene irse con Autodesk?
...
|---|---|---|
| 4–8 mayo | Working sessions con el sponsor | Sponsor + INFRATEK |
| 8 mayo | Reincorporación del gerente general | Habita |
| 11 mayo | Sync con sponsor + coordinadora del proyecto + nuevo lead OT | Habita + INFRATEK |
| 12–13 mayo | Presentación a la dirección | Habita + INFRATEK |
| 15 mayo | Cierre objetivo (firma + anticipo USD $4,500) | Habita + INFRATEK |
| 1 junio | Kickoff del proyecto | INFRATEK |

Notas de equipo:

- La BIM Champion transiciona al rol de coordinadora del proyecto. Su reemplazo en oficina técnica arranca el lunes.
- El proyecto piloto se confirma en las working sessions del 4–8 mayo.
