...
export const metadata: Metadata = {
  ...
  description:
    "Propuesta Integrada v12.0 · visualización en línea del PDF original con marca INFRATEK·HABITA.",
};
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <h1 className="label-spec text-steel-200 truncate">
              <span className="hidden md:inline">
                Propuesta Integrada · INFRATEK × HABITA v12.0
              </span>
              <span className="md:hidden">Propuesta v12.0</span>
            </h1>
          </div>
